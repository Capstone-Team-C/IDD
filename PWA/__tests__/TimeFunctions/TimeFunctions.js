import { subtractTime, milliToFormat, ERROR } from "@/components/Timesheet/TimeFunctions.js";
...
describe("'subtractTime' function", () => {
  test.each(subtract_null)('Given %p and %p as the first two arguments, return an error value', (firstArg, secondArg) => {
    expect(subtractTime(firstArg, secondArg, "")).toBe(ERROR)
  });
  
  test.each(subtract_malformat)('Given malformatted arguments %p and %p with expected format %p, return an error value', (firstArg, secondArg, thirdArg) => {

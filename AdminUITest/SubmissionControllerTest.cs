...
namespace AdminUITest
{
    ...
    public class SubmissionControllerTests
    {
        ...
        public async Task ModalProcess_SubmissionNotFound()
        {
            ...
            var result = await tc.ModalProcess(-1, "Accept", "Nah", "id", "04/01/2020", "04/15/2020", "pName", "cName", "PRIME", "timesheetIndex", 1);
        ...
        { 
            var tc = new SubmissionController(_logger, _scontext);
            var result = await tc.ModalProcess(2, "Accept", "Nah", "id", "04/01/2020", "04/15/2020", "pName", "cName", "PRIME", "timesheetIndex", 1) as ViewResult;
        ...
        public async Task ModalProcess_LockDoesntMatchUser()
        {
            ...
            var result = await tc.ModalProcess(1, "Accept", "Nah", "id", "04/01/2020", "04/15/2020", "pName", "cName", "PRIME", "timesheetIndex", 1) as ViewResult;
            Assert.AreEqual("NoPermission", result.ViewName);
        }
        [Test]
        public async Task ModalProcess_AllGood()
        {
            ...
            var result = await tc.ModalProcess(1, "Accept", "Nah", "id", "04/01/2020", "04/15/2020", "pName", "cName", "PRIME", "timesheetIndex", 1) as RedirectToActionResult;
